...
# ann = load_j256X10_relu_1conv(NETPATH + '256X10_1conv_bigtrain.tfl')
ann = load_100X3_2conv(NETPATH + '100X3_2conv.tfl', learn_rate=0.02)
train_tfl_audio_convnet_model(ann, big_data_train_X, big_data_train_Y, big_data_test_X, big_data_test_Y, num_epochs=30, batch_size=20)
validate3(ann)
ann.save(NETPATH + '100X3_2conv_bigboy.tfl')
