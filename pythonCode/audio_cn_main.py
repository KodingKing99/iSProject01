...
ann = load_100X20X2_relu_1conv_bigfilt(NETPATH + '100X20_relu_1conv_.tfl')
train_tfl_audio_convnet_model(ann, big_data_train_X, big_data_train_Y, big_data_test_X, big_data_test_Y, num_epochs=5)
validate3(ann)
ann.save(NETPATH + '100X20_relu_1conv_bigfilt_v1.tfl')
